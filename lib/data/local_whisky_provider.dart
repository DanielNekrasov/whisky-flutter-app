...
class LocalWhiskyProvider {
  static List<Whisky> whiskies = [
    Whisky(
      ...
      imagePath: 'https://www.lcbo.com/content/dam/lcbo/products/255281.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg',
      shortDescription: 'Ананас, ракитник, медовый солод, ячменный солод, мускатный орех, подсушенный на торфе солод',
    ...
    Whisky(
      ...
      shortDescription: 'Желе из айвы, молочный шоколад, миндальный мёд, гуава, херес олоросо, апельсин',
      region: 'Хайленд, Шотландия',
      category: WhiskyCategory.single_malt,
      fragrance: Flavour.fruit,
      taste: Flavour.sweet,
